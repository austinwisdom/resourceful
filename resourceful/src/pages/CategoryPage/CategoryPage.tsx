...
<<<<<<< HEAD
    ...
    useEffect(() => {
        ...
        try { 
            if(id) {
            const data = await axios.get<ResourcesResponse[]>(`https://backend.resourceful.tips/resources/${id}`);
            setData(data.data);
            }
        } catch(error) {
            console.log(error)
    ...
    return (
        ...
        <div className="category__main-container">
            ...
            <img
                src={`https://backend.resourceful.tips/icons/${id!.slice(0,4)}.png`}
        ...
        <img src={`https://backend.resourceful.tips/blobs/${id!.slice(0,4)}.png`} alt="red blob" className="category__blob" />
        </section>
    );
=======
      <div className="category__main-container">
